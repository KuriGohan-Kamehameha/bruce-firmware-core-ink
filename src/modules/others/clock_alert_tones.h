...
constexpr int CLOCK_ALERT_TONE_CHICKEN_DANCE = 5;
constexpr int CLOCK_ALERT_TONE_OH_CANADA = 6;
constexpr int CLOCK_ALERT_TONE_USSR_ANTHEM = 7;

constexpr int CLOCK_ALERT_TONE_MIN = CLOCK_ALERT_TONE_CLASSIC;
constexpr int CLOCK_ALERT_TONE_MAX = CLOCK_ALERT_TONE_USSR_ANTHEM;
