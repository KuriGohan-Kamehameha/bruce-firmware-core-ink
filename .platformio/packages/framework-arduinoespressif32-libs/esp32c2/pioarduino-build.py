...
env.Append(
    ...
    LINKFLAGS=[
        ...
        "-T", "esp32c2.rom.libc.ld",
        "-T", "esp32c2.rom.libc-suboptimal_for_misaligned_mem.ld",
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "esp_hw_support", "debug_probe", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "esp_hw_support", "mspi_timing_tuning", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "esp_hw_support", "mspi_timing_tuning", "tuning_scheme_impl", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "esp_hw_support", "power_supply", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "heap", "tlsf"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "soc", "esp32c2", "register"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "esp_rom", "esp32c2", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "esp_rom", "esp32c2", "include", "esp32c2"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "esp_security", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "bt", "common", "ble_log", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "cte", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "ras", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "esp_driver_bitscrambler", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "esp_driver_twai", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "rt", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c2", "include", "espressif__esp_modem", "command", "include"),
    ...
    LIBS=[
        "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_uart", "-lapp_trace", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lbt", "-lunity", "-lcmock", "-lconsole", "-lsdmmc", "-lesp_driver_sdspi", "-lesp_driver_tsens", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-lesp_driver_cam", "-lesp_eth", "-lesp_hid", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lesp_https_server", "-lesp_lcd", "-lprotobuf-c", "-lprotocomm", "-lesp_local_ctrl", "-lespcoredump", "-lwear_levelling", "-lfatfs", "-ljson", "-lmqtt", "-lnvs_sec_provider", "-lrt", "-lspiffs", "-lwifi_provisioning", "-lchmorgan__esp-libhelix-mp3", "-lespressif__esp-modbus", "-lespressif__libsodium", "-lespressif__mdns", "-lespressif__esp_modem", "-ljoltwallet__littlefs", "-lfb_gfx", "-lapp_trace", "-lapp_trace", "-lcmock", "-lunity", "-lesp_driver_cam", "-lesp_lcd", "-lesp_local_ctrl", "-lesp_https_server", "-lmqtt", "-lnvs_sec_provider", "-lrt", "-lwifi_provisioning", "-lprotocomm", "-lprotobuf-c", "-ljson", "-lesp_hid", "-lbt", "-lble_app", "-lfatfs", "-lwear_levelling", "-lspiffs", "-lchmorgan__esp-libhelix-mp3", "-lespressif__esp-modbus", "-lespressif__libsodium", "-lespressif__mdns", "-lconsole", "-lesp_eth", "-lespressif__esp_modem", "-ljoltwallet__littlefs", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lsdmmc", "-lesp_driver_sdspi", "-lesp_driver_tsens", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lnet80211", "-lpp", "-lsmartconfig", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lsdmmc", "-lesp_driver_sdspi", "-lesp_driver_tsens", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lnet80211", "-lpp", "-lsmartconfig", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lsdmmc", "-lesp_driver_sdspi", "-lesp_driver_tsens", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lnet80211", "-lpp", "-lsmartconfig", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lsdmmc", "-lesp_driver_sdspi", "-lesp_driver_tsens", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lnet80211", "-lpp", "-lsmartconfig", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lsdmmc", "-lesp_driver_sdspi", "-lesp_driver_tsens", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lnet80211", "-lpp", "-lsmartconfig", "-lc", "-lm", "-lstdc++", "-lpthread", "-lnewlib", "-lgcc", "-lcxx", "-lphy", "-lbtbb", "-lesp_phy", "-lphy", "-lbtbb", "-lesp_phy", "-lphy", "-lbtbb"
    ],
